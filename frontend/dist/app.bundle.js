...
"use strict";
/**
 * Created by Ana Zalozna on 15.03.17.
 */
...
document.querySelector('section').appendChild((0, _functions.component)());
...
var VideoControl = function () {
    function VideoControl(video_block) {
        ...
        this._events = [{ element: this._video, func: this._videoTimeUpdateCallback, event: 'timeupdate' }, { element: this._video, func: this._reloadVideo, event: 'ended' }, { element: this._video, func: this._toggleVideoMode, event: 'click' }, { element: this._play_btn, func: this._play, event: 'click' }, { element: this._stop_btn, func: this._pause, event: 'click' }, { element: this._mute_btn, func: this._mute, event: 'click' }, { element: this._unmute_btn, func: this._unmute, event: 'click' }, { element: this._fullscreen_btn, func: this._turnOnFullScreen, event: 'click' }, { element: this._progress_bar_container, func: this._changeVideoBarPos, event: 'mousedown' }];
    }
    ...
    _createClass(VideoControl, [{
        ...
        value: function implement() {
            ...
            this._events.forEach(function (data) {
                data.element.addEventListener(data.event, function (e) {
                    return data.func.call(_this, e);
                });
            });
        ...
        key: '_toggleVideoMode',
        value: function _toggleVideoMode() {
        ...
        key: '_turnOnFullScreen',
        value: function _turnOnFullScreen() {
        ...
        key: '_videoTimeUpdateCallback',
        value: function _videoTimeUpdateCallback() {
            var progress = this._video.currentTime / this._video.duration * 100;
        ...
        key: '_updateBar',
        value: function _updateBar(x, bar, callback) {
            var position = x - bar.getBoundingClientRect().left,
        ...
        key: '_changeVideoBarPos',
        value: function _changeVideoBarPos(event) {
            var _this2 = this;

            this._updateBar(event.pageX, this._progress_bar_container, function (videoVal) {
                _this2._video.currentTime = _this2._video.duration * videoVal;
            });
        }
        ...
        value: function _showTime() {
            ...
            setInterval(function () {
                var seconds = _this3._video.currentTime,
                    minutes = void 0;
                minutes = Math.floor(seconds / 60);
                minutes = minutes >= 10 ? minutes : "0" + minutes;
                seconds = Math.floor(seconds % 60);
                seconds = seconds >= 10 ? seconds : "0" + seconds;
                _this3._time.innerHTML = minutes + ":" + seconds;
            }, 1000);
        }
    }], [{
        key: '_hide',
...
var _VideoControl = __webpack_require__(6);

var _VideoControl2 = _interopRequireDefault(_VideoControl);
...
function component() {
    ...
    // add search block
    getSearchBlock().then(function (html) {
        // add genres to page
        var search = createNode(html, 'div', 'search');
    ...
    // add genres block
    .then(function () {
        return fetch('http://' + _config2.default.backend_host + '/genres');
    }).then(function (data) {
        return data.json();
    }).then(function (genres) {
        return render('genres', { genres: genres });
    }).then(function (html) {
        // add genres to page
        var genres = createNode(html, 'div', 'genres');
        content.appendChild(genres);
        genres.querySelectorAll('a').forEach(function (element) {
    ...
    // load movies
    .then(function () {
        return fetch('http://' + _config2.default.backend_host + '/movies');
    }).then(function (data) {
        return data.json();
    }).then(function (movies) {
        return loadMovies(movies, content);
...
function filterBySearch(event, content) {
    ...
    var search_value = this.querySelector('input[type="text"]').value;
    if (!search_value) {
        return;
    }

    fetch('http://' + _config2.default.backend_host + '/movies/filter', {
        method: 'POST',
        body: JSON.stringify({
            'search': search_value
        })
...
function loadMovies(data, content) {
    ...
    // clean old video
    content.querySelectorAll('#movie-list li').forEach(function (li) {
        li.parentNode.removeChild(li);
    });

    // add movies to page
    var movies = createNode(html, 'div', 'content');
    content.appendChild(movies);
    movies.querySelectorAll('li').forEach(function (element) {
...
function filterByGenre(event, content) {
    ...
    var genre_id = this.hash.slice(1);

    fetch('http://' + _config2.default.backend_host + '/genres/' + genre_id).then(function (data) {
        return data.json();
    }).then(function (movies) {
        return loadMovies(movies, content);
    }).catch(function (error) {
...
function render(template_name) {
    ...
    var template = __webpack_require__(5)("./" + template_name + '.html');
...
function openPopUP(element) {
    ...
    fetch('http://' + _config2.default.backend_host + '/movies/' + element.id).then(function (data) {
        return data.json();
    }).then(function (movie) {
        return render('popup', movie);
    }).then(function (html) {
        // Put content to popup
        var popup_box = createNode(html, 'div', 'popup_box');
        ...
        var controller = new _VideoControl2.default(popup.querySelector('.video'));
        controller.implement();
    }).then(function () {
        return addComments(element.id, popup);
    }).catch(function (error) {
        console.log(error);
    });
}
...
function addComments(video_id, popup) {
    fetch('http://' + _config2.default.backend_host + '/comments/' + video_id).then(function (data) {
        return data.json();
    }).then(function (comments) {
        return render('comments', { comments: comments });
    }).then(function (comment_html) {
        // add comments block
...
function sendComment(event, video_id) {
    ...
    prepareForm(this).then(function (form_data) {
        // send comment to backend
        Object.assign(comment, form_data, { date: '1 sec ago' });
        Object.assign(form_data, { video_id: video_id });

        return fetch('http://' + _config2.default.backend_host + '/comments/add', {
            method: 'POST',
        ...
        return render('new_comment', comment);
    }).then(function (html) {
        // add comment to html
        var comment_bloc = document.querySelector('.comments_block li');
        if (comment_bloc) {
        ...
        //clean form
        _this.querySelectorAll('input[type="text"], textarea').forEach(function (element) {
            element.value = '';
        });
    }).catch(function (errors) {
        if (Array.isArray(errors)) {
            showErrors(_this.querySelector('.errors'), errors);
        } else {
            showErrors(_this.querySelector('.errors'), ['Oops, something went wrong :(']);
            console.log(errors);
        }
    });
}
...
function prepareForm(form) {
    return new Promise(function (resolve, reject) {
        ...
        var form_data = Object.create(null);
...
function showErrors(parentElement, errors) {
    ...
    parentElement.querySelectorAll('li').forEach(function (li) {
        li.parentNode.removeChild(li);
    });
...
// module
exports.push([module.i, ".controllers .hidden {\n  display: none; }\n\n.controllers .progress-bar {\n  width: 70%;\n  height: 10px;\n  display: inline-block;\n  background-color: #b3c5ff; }\n  .controllers .progress-bar .volume {\n    height: 10px;\n    width: 0;\n    background-color: #8193cd; }\n\n.controllers .time {\n  display: inline-block; }\n", ""]);
...
// module
exports.push([module.i, "body {\n  font: 400 1.2em/1.4 'PT Sans', sans-serif;\n  color: #333;\n  background-color: #405069; }\n\n.wrapper {\n  max-width: 1200px;\n  width: 95%;\n  margin: 0 auto; }\n\n.hide {\n  display: none; }\n\n.center, #genre-list li, #movie-list li {\n  text-align: center; }\n\ninput, textarea {\n  height: 40px;\n  border: none;\n  background-color: #fff; }\n\ntextarea {\n  height: 100px;\n  resize: none;\n  padding: 20px 0 0 20px; }\n\ninput:not([type=\"submit\"]) {\n  padding-left: 20px; }\n\ninput[type=\"submit\"] {\n  cursor: pointer;\n  font-size: .9em;\n  text-transform: uppercase;\n  padding: 0; }\n\n::-webkit-input-placeholder {\n  color: #7e7e7e; }\n\n:-moz-placeholder {\n  color: #7e7e7e; }\n\n/* Firefox 18- (one color)*/\n::-moz-placeholder {\n  color: #7e7e7e; }\n\n/* Firefox 19+ (double colons) */\n:-ms-input-placeholder {\n  color: #7e7e7e; }\n\n:focus::-webkit-input-placeholder {\n  color: transparent; }\n\n:focus:-moz-placeholder {\n  color: transparent; }\n\n/* Firefox 18- (one color)*/\n:focus::-moz-placeholder {\n  color: transparent; }\n\n/* Firefox 19+ (double colons) */\n:focus:-ms-input-placeholder {\n  color: transparent; }\n\n.transition, input[type=\"submit\"], a {\n  -webkit-transition: all .3s ease-in;\n  -moz-transition: all .3s ease-in;\n  -ms-transition: all .3s ease-in;\n  -o-transition: all .3s ease-in;\n  transition: all .3s ease-in; }\n\nul {\n  padding: 0;\n  margin: 0;\n  list-style: none; }\n\na {\n  display: inline-block;\n  color: #fff;\n  text-decoration: none;\n  cursor: pointer; }\n\na:hover {\n  color: #fc503e; }\n\ninput:focus, textarea:focus {\n  outline: none; }\n\n#search_form {\n  display: flex;\n  flex-direction: row;\n  flex-wrap: wrap;\n  justify-content: space-between;\n  align-content: stretch;\n  align-items: stretch; }\n  #search_form input[type=\"text\"] {\n    width: 74%; }\n  #search_form input[type=\"submit\"] {\n    width: 25%;\n    background-color: #fc503e;\n    color: #fff; }\n  #search_form input[type=\"submit\"]:hover {\n    background-color: #fff;\n    color: #333; }\n\n#genre-list {\n  display: flex;\n  flex-direction: row;\n  flex-wrap: wrap;\n  justify-content: flex-start;\n  align-content: stretch;\n  align-items: stretch; }\n  #genre-list li {\n    width: 25%; }\n  #genre-list li a {\n    display: block;\n    padding: 10px; }\n  #genre-list li:nth-child(2n) a {\n    background-color: #fff;\n    color: #333; }\n  #genre-list li:nth-child(2n) a:hover {\n    background-color: #333;\n    color: #fff; }\n  #genre-list li:nth-child(2n+1) a {\n    background-color: #333;\n    color: #fff; }\n  #genre-list li:nth-child(2n+1) a:hover {\n    background-color: #fff;\n    color: #333; }\n\n@media only screen and (max-width: 768px) {\n  #genre-list li {\n    width: 50%; } }\n\n#movie-list {\n  display: flex;\n  flex-direction: row;\n  flex-wrap: wrap;\n  justify-content: space-between;\n  align-content: stretch;\n  align-items: stretch;\n  margin: 20px 0; }\n  #movie-list li {\n    width: 49%;\n    cursor: pointer; }\n    #movie-list li img {\n      width: 100%; }\n    #movie-list li h4 {\n      color: #fff; }\n\n@media only screen and (max-width: 768px) {\n  #movie-list li {\n    width: 100%; } }\n", ""]);
...
// module
exports.push([module.i, "body {\n  font: 400 1.2em/1.4 'PT Sans', sans-serif;\n  color: #333;\n  background-color: #405069; }\n\n.wrapper {\n  max-width: 1200px;\n  width: 95%;\n  margin: 0 auto; }\n\n.hide {\n  display: none; }\n\n.center, #genre-list li {\n  text-align: center; }\n\ninput, textarea {\n  height: 40px;\n  border: none;\n  background-color: #fff; }\n\ntextarea {\n  height: 100px;\n  resize: none;\n  padding: 20px 0 0 20px; }\n\ninput:not([type=\"submit\"]) {\n  padding-left: 20px; }\n\ninput[type=\"submit\"] {\n  cursor: pointer;\n  font-size: .9em;\n  text-transform: uppercase;\n  padding: 0; }\n\n::-webkit-input-placeholder {\n  color: #7e7e7e; }\n\n:-moz-placeholder {\n  color: #7e7e7e; }\n\n/* Firefox 18- (one color)*/\n::-moz-placeholder {\n  color: #7e7e7e; }\n\n/* Firefox 19+ (double colons) */\n:-ms-input-placeholder {\n  color: #7e7e7e; }\n\n:focus::-webkit-input-placeholder {\n  color: transparent; }\n\n:focus:-moz-placeholder {\n  color: transparent; }\n\n/* Firefox 18- (one color)*/\n:focus::-moz-placeholder {\n  color: transparent; }\n\n/* Firefox 19+ (double colons) */\n:focus:-ms-input-placeholder {\n  color: transparent; }\n\n.transition, input[type=\"submit\"], a, .popup_box .popup_content .fa.fa-times {\n  -webkit-transition: all .3s ease-in;\n  -moz-transition: all .3s ease-in;\n  -ms-transition: all .3s ease-in;\n  -o-transition: all .3s ease-in;\n  transition: all .3s ease-in; }\n\nul {\n  padding: 0;\n  margin: 0;\n  list-style: none; }\n\na {\n  display: inline-block;\n  color: #fff;\n  text-decoration: none;\n  cursor: pointer; }\n\na:hover {\n  color: #fc503e; }\n\ninput:focus, textarea:focus {\n  outline: none; }\n\n#search_form {\n  display: flex;\n  flex-direction: row;\n  flex-wrap: wrap;\n  justify-content: space-between;\n  align-content: stretch;\n  align-items: stretch; }\n  #search_form input[type=\"text\"] {\n    width: 74%; }\n  #search_form input[type=\"submit\"] {\n    width: 25%;\n    background-color: #fc503e;\n    color: #fff; }\n  #search_form input[type=\"submit\"]:hover {\n    background-color: #fff;\n    color: #333; }\n\n#genre-list {\n  display: flex;\n  flex-direction: row;\n  flex-wrap: wrap;\n  justify-content: flex-start;\n  align-content: stretch;\n  align-items: stretch; }\n  #genre-list li {\n    width: 25%; }\n  #genre-list li a {\n    display: block;\n    padding: 10px; }\n  #genre-list li:nth-child(2n) a {\n    background-color: #fff;\n    color: #333; }\n  #genre-list li:nth-child(2n) a:hover {\n    background-color: #333;\n    color: #fff; }\n  #genre-list li:nth-child(2n+1) a {\n    background-color: #333;\n    color: #fff; }\n  #genre-list li:nth-child(2n+1) a:hover {\n    background-color: #fff;\n    color: #333; }\n\n@media only screen and (max-width: 768px) {\n  #genre-list li {\n    width: 50%; } }\n\n.popup_box {\n  background: rgba(0, 0, 0, 0.8);\n  width: 100%;\n  height: 100%;\n  position: fixed;\n  z-index: 99;\n  top: 0;\n  left: 50%;\n  transform: translate(-50%, 0%); }\n  .popup_box .popup_content {\n    overflow: auto;\n    position: absolute;\n    z-index: 999;\n    left: 50%;\n    top: 3%;\n    transform: translate(-50%, 0%);\n    padding: 25px;\n    background: #e8e8e8;\n    box-sizing: border-box;\n    border-radius: 5px;\n    height: 100%; }\n    .popup_box .popup_content .fa.fa-times {\n      position: absolute;\n      color: #020f17;\n      cursor: pointer;\n      top: 0;\n      right: 0;\n      font-size: 2.3em;\n      padding: 10px 20px;\n      text-align: right; }\n    .popup_box .popup_content .fa.fa-times:hover {\n      color: #fc503e; }\n    .popup_box .popup_content .video video {\n      width: 715px; }\n\n.controllers {\n  display: flex;\n  flex-direction: row;\n  flex-wrap: nowrap;\n  justify-content: space-between;\n  align-content: stretch;\n  align-items: center;\n  margin-top: 20px; }\n  .controllers i {\n    cursor: pointer; }\n\n.add-comment input, .add-comment textarea {\n  width: 100%;\n  background-color: #333;\n  color: #fff;\n  font-size: 1em; }\n\n.add-comment textarea {\n  margin: 10px 0; }\n\n.add-comment input[type=\"submit\"] {\n  background-color: #fc503e;\n  width: 200px; }\n\n.add-comment input[type=\"submit\"]:hover {\n  background-color: #333; }\n\n.comments_block {\n  margin: 40px 0;\n  border-top: 2px dashed #ccc; }\n  .comments_block h4 {\n    margin-bottom: 10px; }\n\n@media only screen and (max-width: 768px) {\n  .popup_box .popup_content .video video {\n    width: 500px; } }\n\n@media only screen and (max-width: 550px) {\n  .popup_box .popup_content .video video {\n    width: 270px; } }\n", ""]);
...
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("<form class=\"add-comment\">");t.b("\n" + i);t.b("    <ul class=\"errors\">");t.b("\n" + i);t.b("    </ul>");t.b("\n" + i);t.b("    <h3>Leave your comment:</h3>");t.b("\n" + i);t.b("    <input name=\"name\" type=\"text\" placeholder=\"Name\" required>");t.b("\n" + i);t.b("    <textarea name=\"message\" placeholder=\"Message\"></textarea>");t.b("\n" + i);t.b("    <input type=\"submit\">");t.b("\n" + i);t.b("</form>");t.b("\n" + i);t.b("<ul class=\"comments_block\">");t.b("\n" + i);if(t.s(t.f("comments",c,p,1),c,p,0,300,392,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("    <li>");t.b("\n" + i);t.b("        <h4>");t.b(t.v(t.f("name",c,p,0)));t.b(" (");t.b(t.v(t.f("date",c,p,0)));t.b(")</h4>");t.b("\n" + i);t.b("        <div>");t.b(t.v(t.f("message",c,p,0)));t.b("</div>");t.b("\n" + i);t.b("    </li>");t.b("\n" + i);});c.pop();}t.b("</ul>");return t.fl(); },partials: {}, subs: {  }}, "<form class=\"add-comment\">\n    <ul class=\"errors\">\n    </ul>\n    <h3>Leave your comment:</h3>\n    <input name=\"name\" type=\"text\" placeholder=\"Name\" required>\n    <textarea name=\"message\" placeholder=\"Message\"></textarea>\n    <input type=\"submit\">\n</form>\n<ul class=\"comments_block\">\n    {{#comments}}\n    <li>\n        <h4>{{name}} ({{date}})</h4>\n        <div>{{message}}</div>\n    </li>\n    {{/comments}}\n</ul>", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(0);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("<div class=\"wrapper\">");t.b("\n" + i);t.b("    <ul id=\"genre-list\">");t.b("\n" + i);if(t.s(t.f("genres",c,p,1),c,p,0,66,145,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("        <li>");t.b("\n" + i);t.b("            <a href=\"#");t.b(t.v(t.f("id",c,p,0)));t.b("\">");t.b(t.v(t.f("name",c,p,0)));t.b("</a>");t.b("\n" + i);t.b("        </li>");t.b("\n" + i);});c.pop();}t.b("    </ul>");t.b("\n" + i);t.b("</div>");return t.fl(); },partials: {}, subs: {  }}, "<div class=\"wrapper\">\n    <ul id=\"genre-list\">\n        {{#genres}}\n        <li>\n            <a href=\"#{{id}}\">{{name}}</a>\n        </li>\n        {{/genres}}\n    </ul>\n</div>", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(0);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("<div class=\"wrapper\">");t.b("\n" + i);t.b("    <ul id=\"movie-list\">");t.b("\n" + i);if(t.s(t.f("movies",c,p,1),c,p,0,66,202,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("        <li id=\"");t.b(t.v(t.f("id",c,p,0)));t.b("\">");t.b("\n" + i);t.b("            <div><img src=\"/");t.b(t.v(t.f("thumb",c,p,0)));t.b("\"></div>");t.b("\n" + i);t.b("            <h4>");t.b(t.v(t.f("title",c,p,0)));t.b(" (");t.b(t.v(t.f("year",c,p,0)));t.b(")</h4>");t.b("\n" + i);t.b("        </li>");t.b("\n" + i);});c.pop();}t.b("    </ul>");t.b("\n" + i);t.b("</div>");return t.fl(); },partials: {}, subs: {  }}, "<div class=\"wrapper\">\n    <ul id=\"movie-list\">\n        {{#movies}}\n        <li id=\"{{id}}\">\n            <div><img src=\"/{{thumb}}\"></div>\n            <h4>{{title}} ({{year}})</h4>\n        </li>\n        {{/movies}}\n    </ul>\n</div>", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(0);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("<h4>");t.b(t.v(t.f("name",c,p,0)));t.b(" (");t.b(t.v(t.f("date",c,p,0)));t.b(")</h4>");t.b("\n" + i);t.b("<div>");t.b(t.v(t.f("message",c,p,0)));t.b("</div>");return t.fl(); },partials: {}, subs: {  }}, "<h4>{{name}} ({{date}})</h4>\n<div>{{message}}</div>", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(0);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("<div class=\"popup_content\">");t.b("\n" + i);t.b("    <a class=\"close\" href=\"#\"><i class=\"fa fa-times\"></i></a>");t.b("\n" + i);t.b("    <h2>");t.b(t.v(t.f("title",c,p,0)));t.b("</h2>");t.b("\n" + i);t.b("    <div class=\"video\">");t.b("\n" + i);t.b("        <video controls>");t.b("\n" + i);t.b("            <source src=\"/");t.b(t.v(t.f("link",c,p,0)));t.b("\" type=\"video/mp4\">");t.b("\n" + i);t.b("            Your browser does not support the video tag.");t.b("\n" + i);t.b("        </video>");t.b("\n" + i);t.b("        <div class=\"controllers\">");t.b("\n" + i);t.b("            <i class=\"fa fa-play\"></i>");t.b("\n" + i);t.b("            <i class=\"fa fa-pause hidden\"></i>");t.b("\n" + i);t.b("            <i class=\"fa fa-volume-off hidden\"></i>");t.b("\n" + i);t.b("            <i class=\"fa fa-volume-up\"></i>");t.b("\n" + i);t.b("            <div class=\"progress-bar\">");t.b("\n" + i);t.b("                <div class=\"volume\"></div>");t.b("\n" + i);t.b("            </div>");t.b("\n" + i);t.b("            <div class=\"time\"></div>");t.b("\n" + i);t.b("            <i class=\"fa fa-arrows-alt\"></i>");t.b("\n" + i);t.b("        </div>");t.b("\n" + i);t.b("    </div>");t.b("\n" + i);t.b("    <p>");t.b(t.v(t.f("description",c,p,0)));t.b("</p>");t.b("\n" + i);t.b("</div>");return t.fl(); },partials: {}, subs: {  }}, "<div class=\"popup_content\">\n    <a class=\"close\" href=\"#\"><i class=\"fa fa-times\"></i></a>\n    <h2>{{title}}</h2>\n    <div class=\"video\">\n        <video controls>\n            <source src=\"/{{link}}\" type=\"video/mp4\">\n            Your browser does not support the video tag.\n        </video>\n        <div class=\"controllers\">\n            <i class=\"fa fa-play\"></i>\n            <i class=\"fa fa-pause hidden\"></i>\n            <i class=\"fa fa-volume-off hidden\"></i>\n            <i class=\"fa fa-volume-up\"></i>\n            <div class=\"progress-bar\">\n                <div class=\"volume\"></div>\n            </div>\n            <div class=\"time\"></div>\n            <i class=\"fa fa-arrows-alt\"></i>\n        </div>\n    </div>\n    <p>{{description}}</p>\n</div>", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(0);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("<div class=\"wrapper\">");t.b("\n" + i);t.b("    <form id=\"search_form\">");t.b("\n" + i);t.b("        <input type=\"text\" required name=\"search\">");t.b("\n" + i);t.b("        <input type=\"submit\">");t.b("\n" + i);t.b("    </form>");t.b("\n" + i);t.b("</div>");return t.fl(); },partials: {}, subs: {  }}, "<div class=\"wrapper\">\n    <form id=\"search_form\">\n        <input type=\"text\" required name=\"search\">\n        <input type=\"submit\">\n    </form>\n</div>", H);return T.render.apply(T, arguments); };
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/lib/loader.js!./movies.scss", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/lib/loader.js!./movies.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
